...
require (
	...
	github.com/uncloud-registry/swarm-driver v0.0.1
...
require (
	...
	github.com/ethersphere/bee/v2 v2.2.0 // indirect
...
replace github.com/uncloud-registry/swarm-driver => ../swarm-driver

replace github.com/ethersphere/bee/v2 => github.com/ethersphere/bee/v2 v2.2.0
...
require (
	...
	github.com/prometheus/client_golang v1.18.0 // indirect; updated to latest
